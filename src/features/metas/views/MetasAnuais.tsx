...
export const MetasAnuais: React.FC = () => {
  ...
  const getContextoConfig = (contexto: string) => {
    const configs: Record<string, any> = {
      ...
      outros: { icon: MoreHorizontal, gradient: 'from-gray-500 to-slate-600' }
    };
  ...
  const metasDoAno = getMetasPorTipo('anual', anoSelecionado.toString());

  useEffect(() => {
    if (metasDoAno.length > 0) {
      const todasConcluidas = metasDoAno.every(meta => meta.status === 'concluida');
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 dark:from-slate-950 dark:via-gray-950 dark:to-slate-900 relative overflow-hidden">
      ...
      >
        <div className="flex items-center justify-between mb-8">
          ...
          <Button onClick={abrirModalCriar} className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white shadow-lg shadow-cyan-500/30 transition-all duration-300 h-11 px-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-1">
                  {tarefasDoAno.filter(t => t.status === 'concluida').length}
                </p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-1">
                  {tarefasDoAno.filter(t => t.status === 'andamento').length}
                </p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-1">
                  {tarefasDoAno.filter(t => t.status === 'pendente').length}
                </p>
              </div>
