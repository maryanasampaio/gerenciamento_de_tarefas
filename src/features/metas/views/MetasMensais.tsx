...
export const MetasMensais: React.FC = () => {
  ...
  const metasDoMes = getMetasPorTipo('mensal', mesAnoFormatado);

  useEffect(() => {
    if (metasDoMes.length > 0) {
      const todasConcluidas = metasDoMes.every(meta => meta.status === 'concluida');
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-1">
                  {tarefasDoMes.filter(t => t.status === 'concluida').length}
                </p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-1">
                  {tarefasDoMes.filter(t => t.status === 'andamento').length}
                </p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-1">
                  {tarefasDoMes.filter(t => t.status === 'pendente').length}
                </p>
              </div>
